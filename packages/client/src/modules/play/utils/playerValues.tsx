...
function getLastCompletedStepPlayerValues(game: IGame, personaByStep: Record<number, Persona>) {
  if (game.step === 0) {
...
function getPlayerValuesByStep(step: number, game: IGame, personaByStep: Record<number, Persona>) {
  if (step === 0) {
    return personaByStep[0]
